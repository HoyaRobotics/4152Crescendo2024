...
public class TunerConstants {
    ...
    private static final double kSlipCurrentA = 50; //80

    // Theoretical free speed (m/s) at 12v applied output;
    // This needs to be tuned to your individual robot
    public static final double kSpeedAt12VoltsMps = 4.35; //4.73
    ...
    private static final double kWheelRadiusInches = 1.88463;//1.97
    ...
    private static final double kFrontLeftEncoderOffset = -0.4560546875;
    ...
    private static final double kFrontRightEncoderOffset = 0.380615234375;
    ...
    private static final double kBackRightEncoderOffset = -0.4375;
