...
public class ShootPoseDefence extends Command {
  ...
  public ShootPoseDefence(CommandSwerveDrivetrain drivetrain, Shooter shooter, Intake intake) {
  ...
  public void initialize() {
    ...
    distanceController.setSetpoint(2.9); //2.69
